  ...
  return (
    <div>
      ...
      <main>
        ...
        <section id="feedback" class="border-b py-8">
          <div class="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div class="flex-1 rounded-t rounded-b-none overflow-hidden shadow">
                ...
                >
                  <p class="w-full text-xs md:text-sm px-6 mt-6">
                    GETTING STARTED
                  </p>
              ...
              <div class="flex-none mt-auto rounded-b rounded-t-none overflow-hidden shadow p-6">
                <div class="flex items-center justify-start">
                  <button class="mx-auto lg:mx-0 hover:underline gradient2 font-extrabold rounded my-6 py-4 px-8 shadow-lg">
                    Action
                  </button>
                </div>
              </div>
        ...
        <section class="gradient w-full mx-auto text-center pt-6 pb-12">
          <h2 class="w-full my-2 text-2xl md:text-4xl font-black leading-tight text-center text-white">
            Call to Action
          </h2>
          <div class="w-full mb-4">
          ...
          <button class="mx-auto lg:mx-0 hover:underline font-bold rounded my-6 py-4 px-8 shadow-lg">
            Action!
          </button>
        </section>
          ...
          <div class="container mx-auto mt-8 px-8">
            <div class="w-full flex flex-col md:flex-row py-6">
              <div class="flex-1 mb-6">
                ...
                <p class="text-gray-500">&copy; Copyright 2021 Ananab Cabs</p>
              </div>
                ...
                <ul class="list-reset mb-6">
                  <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a
                      ...
                      class="font-light no-underline hover:underline hover:text-orange-500"
                    >
                      <i className="mdi mdi-facebook text-blue-700"></i>{" "}
                      Facebook
                    </a>
                  </li>
                  <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a
                      ...
                      class="font-light no-underline hover:underline hover:text-orange-500"
                    >
                      <i className="mdi mdi-instagram text-red-400"></i>{" "}
                      Instagram
                    </a>
                  </li>
                  <li class="mt-2 inline-block mr-2 md:block md:mr-0">

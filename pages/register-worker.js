            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              <div className="text-center mb-10">
                ...
                <div className="p-4 rounded-xl shadow-xl">
                  ...
                  <button
                    type="button"
                    className="mx-auto lg:mx-0 gradient text-gray-900 text-xl font-bold rounded-full mb-3 py-3 px-10 bg-gradient-to-r from-yellow-200 to-yellow-500 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                  >
